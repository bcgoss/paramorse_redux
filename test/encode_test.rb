...
class EncoderTest < Minitest::Test
  ...
  def test_can_encode_with_space
    ...
    assert_equal "100010000000", e.encode("ee ")
    assert_equal "100000000000000", e.encode("e  ")
    

  end

  def test_it_encodes_many_spaces
    skip
    e = Paramorse::Encoder.new
    assert_equal "00000001000100000000000000100010000000", e.encode(" ee  ee ")
    # doesn't pass yet. multiple internal white spce is hard
  end
